...
namespace CW.BO.DataModel
{
    public class FormButtonDTO
    {
        ...
        public string btn15 { get; set; }
        public string btn16 { get; set; }
        public string btn17 { get; set; }
        public string btn18 { get; set; }
        public string btn19 { get; set; }
        public string btn20 { get; set; }
